...
font = 'Open_Sans/OpenSans-Bold.ttf'
img = ImageText((1080, 1080), background=(255, 255, 255, 200)) # 200 = alpha
...
#img.write_text_box((300, 125), text, box_width=200, font_filename=font, font_size=40, color=color, place='right')
img.write_text_box((100, 100), text, box_width=200, font_filename=font,
...
'''img.write_text((100, 350), text, font_filename=font,
               font_size='fill', max_height=150, color=color)'''

img.save('sample-imagetext1.png')